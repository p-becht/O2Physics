...
DECLARE_SOA_TABLE(HfCandLcFulls, "AOD", "HFCANDLCFULL",
                  ...
                  hf_cand::ErrorImpactParameter1,
                  hf_cand::ErrorImpactParameter2,
                  hf_cand::ImpactParameterZ0, // DCAz 
                  hf_cand::ImpactParameterZ1, // DCAz
                  hf_cand::ImpactParameterZ2, // DCAz
                  hf_cand::ErrorImpactParameterZ0,
                  hf_cand::ErrorImpactParameterZ1,
                  hf_cand::ErrorImpactParameterZ2,
                  hf_cand::SecondaryDCA0, // DCAxy
                  hf_cand::SecondaryDCA1, // DCAxy
                  hf_cand::SecondaryDCA2, // DCAxy
                  hf_cand::ErrorSecondaryDCA0, 
                  hf_cand::ErrorSecondaryDCA1, 
                  hf_cand::ErrorSecondaryDCA2,
                  hf_cand::SecondaryDCAZ0, // DCAz
                  hf_cand::SecondaryDCAZ1, // DCAz
                  hf_cand::SecondaryDCAZ2, // DCAz
                  hf_cand::ErrorSecondaryDCAZ0, 
                  hf_cand::ErrorSecondaryDCAZ1, 
                  hf_cand::ErrorSecondaryDCAZ2,
                  full::NSigTpcPi0,
                  full::NSigTpcPr0,
                  full::NSigTofPi0,
                  full::NSigTofPr0,
        ...
        if (FunctionSelection >= 1 && (/*keep all*/ (!keepOnlySignalMc && !keepOnlyBkg) || /*keep only signal*/ (keepOnlySignalMc && isMcCandidateSignal) || /*keep only background and downsample it*/ (keepOnlyBkg && !isMcCandidateSignal && (candidate.pt() > downSampleBkgPtMax || (pseudoRndm < downSampleBkgFactor && candidate.pt() < downSampleBkgPtMax))))) {
          if (fillCandidateLiteTable) {
            ...
            rowCandidateFull(
              ...
              candidate.secondaryDCA0(),
              candidate.secondaryDCA1(),
              candidate.secondaryDCA2(),
              candidate.errorSecondaryDCA0(),
              candidate.errorSecondaryDCA1(),
              candidate.errorSecondaryDCA2(),
              candidate.secondaryDCAZ0(),
              candidate.secondaryDCAZ1(),
              candidate.secondaryDCAZ2(),
              candidate.errorSecondaryDCAZ0(),
              candidate.errorSecondaryDCAZ1(),
              candidate.errorSecondaryDCAZ2(),
              trackPos1.tpcNSigmaPi(),
              trackPos1.tpcNSigmaPr(),
              trackPos1.tofNSigmaPi(),
              trackPos1.tofNSigmaPr(),
